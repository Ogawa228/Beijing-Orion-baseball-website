...
最后整理：2026-05-15  
当前线上：`express-knlw-032`

部署状态：2026-05-15 16:28 已部署 `players.html?wallpaper=1` 动态壁纸模式；部署后仅本文档有记录性更新。
...
| `players.html` | 球员墙 | 首屏星阵头像节点、题字“猎户群星闪耀时”、点击节点弹 v2.4 球星卡、管理员星阵编队台；`?wallpaper=1` 可作为 Wallpaper Engine 动态壁纸源 | 星阵优先；球星卡只在点击后 modal 出现；壁纸模式隐藏操作 UI，只保留全屏星阵和管理员发布的动效 |
